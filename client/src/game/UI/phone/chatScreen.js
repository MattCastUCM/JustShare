    ...
    createTextBox() {
        ...
        this.textBox.on('pointerdown', () => {
            if (!this.scene.dialogManager.isTalking()) {
                ...
                this.phone.phoneManager.trackerManager.sendItemInteraction("phoneAnswerButton");
                ...
                if (this.boxClickable) {
                    ...
                    if (fadeColor != null && this.currNode) {
                        fadeColor.on('complete', () => {
                            ...
                            this.phone.phoneManager.trackerManager.sendAnsweredChat(this.currNode.fullId, this.name);
    ...
    processNode() {
        if (this.currNode) {
            ...
            // Si el nodo es de tipo evento, hace que el dialogManager lo procese y pasa al siguiente nodo
                ...
                this.phone.phoneManager.trackerManager.sendCanAnswerChat(this.currNode.fullId, this.name);
            }
            else {
                this.setInteractive();
    ...
    generateNotifications(amount) {
        ...
        if (this.notificationAmount === 0) {
            if (this.notifications.container.visible) {
                ...
                this.phone.phoneManager.trackerManager.sendNotificationsCleared(this.name);
            }
        ...
        // Si hay notificaciones, se muestra el icono y actualiza el texto
            ...
            if (!this.notifications.container.visible) {
                ...
                this.phone.phoneManager.trackerManager.sendNotificationReceived(this.name);
            }
