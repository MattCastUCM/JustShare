...
export default class Preloader extends Scene {
    ...
    */
    ...
    loadUIAssets() {
        ...
        this.load.image('thoughtCloud', 'thoughtCloud.png');
        this.load.image('introIcon', 'introIcon.png');
    }
    ...
    preload() {
        ...
        translatorManager.loadDialogs(this, this.dialogs);
    ...
    async create() {
        ...
        const translatorManager = TranslatorManager.getInstance();
        await translatorManager.loadNamespaces(this.dialogs, this.namespaces);
